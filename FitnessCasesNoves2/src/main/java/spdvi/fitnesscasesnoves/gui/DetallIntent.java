 ...
 * @author Rulox
 */
public class DetallIntent extends javax.swing.JFrame {
    ...
    public DetallIntent(String intent) {
    ...
    public DetallIntent(String intent,int id, String exercici) {
        this.idIntent = intent;
        this.id = id;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetallIntent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetallIntent().setVisible(true);
            }
        });
    }
